...
./out/mi_chmod disco 6 /dir1/dir11/   
echo
...
./out/mi_touch disco 6 /dir1/dir11/fic112  
echo
...
./out/mi_escribir  disco /dir1/dir11/fic111 "$(cat texto2.txt)" 0
echo
echo -e "\x1B[38;2;17;245;120m######################################################################\x1b[0m"
echo -e "\x1B[38;2;17;245;120m$ ./mi_ls disco /dir1/dir11/fic111\x1b[0m"
./out/mi_ls -l disco /dir1/dir11/fic111
echo
echo -e "\x1B[38;2;17;245;120m$ ./leer_sf disco\x1b[0m"
./out/leer_sf disco
echo
echo -e "\x1B[38;2;17;245;120m$ ./mi_cat  disco /dir1/dir11/fic111>ext1.txt\x1b[0m"
./out/mi_cat  disco /dir1/dir11/fic111>ext1.txt
echo
...
./out/mi_escribir disco /dir1/dir11/fic112 "hola1"  209000
echo
echo -e "\x1B[38;2;17;245;120m$ ./mi_stat disco /dir1/dir11/fic112\x1b[0m"
./out/mi_stat disco /dir1/dir11/fic112
echo
echo -e "\x1B[38;2;17;245;120m######################################################################\x1b[0m"
...
./out/mi_escribir disco /dir1/dir11/fic112 "hola2" 9000 
echo
echo -e "\x1B[38;2;17;245;120m$ ./mi_stat disco /dir1/dir11/fic112\x1b[0m"
./out/mi_stat disco /dir1/dir11/fic112
echo
...
./out/mi_escribir disco /dir1/dir11/fic112 "hola3"  9100
echo
echo -e "\x1B[38;2;17;245;120m$ ./mi_stat disco /dir1/dir11/fic112\x1b[0m"
./out/mi_stat disco /dir1/dir11/fic112
echo
...
./out/mi_link disco /dir1/dir11/fic113 /dir2/dir21/fic211
echo
echo -e "\x1B[38;2;17;245;120m"
echo "                                 /"
...
./out/mi_stat disco /dir1/dir11/fic113 
echo
...
./out/mi_link disco /dir1/dir11/fic14 /di2/dir21/fic212  #camino1 ha de existir 
echo
echo -e "\x1B[38;2;17;245;120m######################################################################\x1b[0m"
echo -e "\x1B[38;2;17;245;120m$ ./mi_link disco /dir1/dir11/fic113 /dir2/dir21/fic211\x1b[0m"
echo -e "\x1B[38;2;17;245;120m#camino2 NO ha de existir\x1b[0m"
./out/mi_link disco /dir1/dir11/fic113 /dir2/dir21/fic211 #camino2 NO ha de existir
echo
echo -e "\x1B[38;2;17;245;120m######################################################################\x1b[0m"
...
for i in $(seq 0 16)
do
    ./out/mi_mkdir disco 6 /dir3/sd$i/
done
echo
echo -e "\x1B[38;2;17;245;120m"
echo "             /"
